export const Squiggly = () => {
    ...
    return (
        <>
            ...
            <p><img src="/Projects/Squiggly/PageImages/game_console.jpg" alt="game console" style={{ width: "200px" }} /> <img src="/Projects/Squiggly/PageImages/Flappy Bird.gif" alt="flappy bird" style={{ width: "300px" }} /></p>
        </>
    )
}
